...
const QuizApp = () => {
  ...
  const handleShowHint = (e) => {
    if (
      document.querySelector(".hint-container").classList.contains("hidden")
    ) {
  ...
  return (
    <div className="w-full min-h-screen px-[10%] pt-12">
      <div className="relative">
        ...
        <div className="absolute right-0 top-1/2 -translate-y-1/2 text-2xl text-slate-300">
          Score:
    ...
    />
          ...
          <h1 className="text-2xl font-semibold mb-8 text-center mb-10">
            Guess the gesture for this letter.
          </h1>
          <div className="text-container w-[70%] mx-auto mb-10">
            <h1 className="text-[14rem] font-semibold text-center">
              {shuffledList[0].alt}
            </h1>
          </div>
          <div className="flex justify-around  items-center w-full">
            <button
              className="bg-bgColor py-2 px-4 rounded-md hint-btn"
              onClick={handleShowHint}
            >
              Show Hint
            </button>
            <button
              className="bg-bgColor py-2 px-4 rounded-md"
              onClick={handleClose}
            >
              Close
            </button>
