...
import {sign_0} from './0sign';
import {sign_1} from './1sign';
import {sign_2} from './2sign';
import {sign_3} from './3sign';
import {sign_4} from './4sign';
import {sign_5} from './5sign';
import {sign_6} from './6sign';
import {sign_7} from './7sign';
import {sign_8} from './8sign';
import {sign_9} from './9sign';
import {phrase_ily} from './0phrase_ily';
import {phrase_yes} from './0phrase_yes';
