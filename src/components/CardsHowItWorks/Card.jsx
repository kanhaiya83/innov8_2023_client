...
const card = (item) => {
  ...
  const opacityProgress = useTransform(scrollYProgress, [0, 1], [0.2, 1.2]);
  ...
  return (
    <motion.div
      ...
      key={item.step}
      className="bg-black flex items-center gap-12 rounded-3xl sticky flex-col md:flex-row shadow-xl  top-[30vh] w-[400px] sm:w-[600px] lg:w-[900px] overflow-hidden p-4 md:py-12 scale:75 sm:scale-90 md:scale:100 "
    >
